...
defmodule Nitory.MiddlewareTest do
  ...
  test "middlewares" do
    dispose_1 =
      Nitory.Middleware.register(fn session, next ->
    ...
    dispose_5 =
      Nitory.Middleware.register(Nitory.MiddlewareTest.TestGenServer, :feed, [2, "b"], :prepend)

    Logger.info(Nitory.Middleware.list_mw())

    Nitory.Middleware.excute({})
