defmodule Nitory.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {Finch, name: Nitory.Finch},
      # Start a worker by calling: Nitory.Worker.start_link(arg)
      # {Nitory.Worker, arg},
  ...
  def config_change(changed, _new, removed) do
    NitoryWeb.Endpoint.config_change(changed, removed)
    :ok
  end
